# The (surprisingly) fast PVector override from Piazza
# What on earth is going on in the Processing PVector that makes it so much slower?
class PVector:
    ...
    # This method is added because for some reason it was missing
