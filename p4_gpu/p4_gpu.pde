...
void draw() {
  ...
  //vertex(50, 300, 0, 0, 1);
  for (int row = 0; row < 50; row += 1) {
    for (int col = 0; col < 50; col += 1) {
      float x1 = 50 + ((250 / 50) * row);
      float x2 = 50 + ((250 / 50) * (row + 1));
      float y1 = 50 + ((250 / 50) * col);
      float y2 = 50 + ((250 / 50) * (col + 1));
      vertex(x1, y1, 0, row / 50.0, col / 50.0);
      vertex(x2, y1, 0, (row + 1) / 50.0, col / 50.0);
      vertex(x2, y2, 0, (row + 1) / 50.0, (col + 1) / 50.0);
      vertex(x1, y2, 0, row / 50.0, (col + 1) / 50.0);
    } 
  }
  endShape();
  popMatrix();
